...
try:
with open("last_email_timestamp.txt", "r") as timestamp_file:
...
with open("last_email_timestamp.txt", "w") as timestamp_file:
...
# add condition above to send email if time is longer and last error is
same send mail
return True
else :
return False
...
print("Serial OK")
# email test
#email_alert("Check It Out", "Look what I got to work!! Emailing you from
python", "stevehay@oregonstate.edu")
...
file_set = open("/home/seaweed/Documents/Capstone Updata
2.28.24/WebageSeparate/setpoints.csv","r")
